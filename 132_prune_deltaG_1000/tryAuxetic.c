...
import location;
import string;
//string srcFn = "/home/daniel/Documents/auxetic/runs/027_create_finite/starting_config_4_2_nParticles_300.xml";
//string srcFn = "/home/daniel/Documents/auxetic/runs/027_create_finite/starting_config_5.000000_nParticles_2000_aspect_1.000000.xml";
...
string readCutsFn = "/home/danielreid/swift-auxetic/runs/swift-repo/132_prune_deltaG_1000/out/cutBonds.dat";
...
//string setupInitState = "drivers.cutBondIdxsFromFile(\"%s\")" % readCutsFn;
string setupInitState = "drivers.setupInitState(\"%s\", \"%s\")" % (srcFn, readCutsFn);
printf("%s", setupInitState);
